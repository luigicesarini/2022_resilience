...
SEAS=args[2]
SPLIT = args[3]#"RANDOM"
WITH_SS = ifelse(args[4]=="yes",TRUE,FALSE)
SAVE_MAPS_METRIC = ifelse(args[5]=="yes",TRUE,FALSE)
print(paste(args[1],args[2],args[3],args[4],args[5]))
...
if (WITH_SS){
        ...
        tmap_save(tmap_arrange(ll_bias,1,3), glue("../figures/my_{M}_bias_{SEAS}_{SPLIT}.png"), width = 32, height = 12, units="cm", dpi = 300)
...
ggsave(glue("../figures/myboxplotbias_{M}_{SEAS}_{SPLIT}.png"),plot=bb_1,width=10.1,height=10.1,units='in')
